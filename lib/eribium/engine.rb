module Eribium
  class Engine < Rails::Engine
    ...
    initializer "eribium.environment", :before => :load_config_initializers do |app|
      ...
      #Eribium::Config = app.config.eribium.preferences
    end    
    ...
    initializer "eribium.assets.precompile", :group => :all do |app|
    ...
    initializer "eribium.autoload.paths" do |app|
      ...
      #app.config.autoload_paths.reject!{|path| load_paths.include?(path) }
